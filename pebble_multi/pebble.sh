...
roachprod run $name -- "tmux new -d -s ycsb \"./$binary.o bench ycsb /mnt/data1 --workload F --initial-keys 100000 -c $workers --max-size=$maxSize -d 0m --wait-compactions $verbose 1> output.txt 2>verbose.txt\""
